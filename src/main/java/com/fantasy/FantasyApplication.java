...
/*			List<Player> playerList = new ArrayList();
			...
			journeyRepo.save(gw1);
			journeyRepo.save(gw2);
			journeyRepo.save(gw3);
			journeyRepo.save(gw4);
			journeyRepo.save(gw5);
			journeyRepo.save(gw6);
			journeyRepo.save(gw7);
			journeyRepo.save(gw8);
			journeyRepo.save(gw9);
			journeyRepo.save(gw10);
			journeyRepo.save(gw11);
			journeyRepo.save(gw12);
			journeyRepo.save(gw13);
			journeyRepo.save(gw14);
			journeyRepo.save(gw15);
			journeyRepo.save(gw16);
			journeyRepo.save(gw17);
			journeyRepo.save(gw18);
			journeyRepo.save(gw19);
			journeyRepo.save(gw20);
			journeyRepo.save(gw21);
			journeyRepo.save(gw22);
			journeyRepo.save(gw23);
			journeyRepo.save(gw24);
			journeyRepo.save(gw25);
			journeyRepo.save(gw26);
			journeyRepo.save(gw27);
			journeyRepo.save(gw28);
			journeyRepo.save(gw29);
			journeyRepo.save(gw30);
			journeyRepo.save(gw31);
			journeyRepo.save(gw32);
			journeyRepo.save(gw33);
			journeyRepo.save(gw34);
			...
			gameList.add(new Game(format.parse("2015-08-16 15:00:00"),setubal,porto,gw1));
			...
			gameList.add(new Game(format.parse("2015-08-16 17:15:00"),sporting,nacionalMadeira,gw1));
			...
			gameList.add(new Game(format.parse("2015-08-21 19:30:00"),rioAve,sporting,gw2));
			...
			gameList.add(new Game(format.parse("2015-08-23 16:00:00"),porto,tondela,gw2));
			...
			gameList.add(new Game(format.parse("2015-08-30 16:00:00"),sporting,porto,gw3));
			...
			gameList.add(new Game(format.parse("2015-09-13 15:00:00"),estoril,sporting,gw4));
			...
			gameList.add(new Game(format.parse("2015-09-14 19:00:00"),porto,pacos,gw4));
			...
			gameList.add(new Game(format.parse("2015-09-20 15:00:00"),academica,porto,gw5));
			...
			gameList.add(new Game(format.parse("2015-09-21 18:00:00"),sporting,maritimo,gw5));
			...
			gameList.add(new Game(format.parse("2015-09-26 19:45:00"),porto,sporting,gw6));
			...
			gameList.add(new Game(format.parse("2015-09-27 18:15:00"),guimaraes,sporting,gw6));
			...
			gameList.add(new Game(format.parse("2015-10-03 19:45:00"),rioAve,porto,gw7));
			gameList.add(new Game(format.parse("2015-10-04 17:00:00"),sporting,arouca,gw7));
			...
			gameList.add(new Game(format.parse("2015-10-23 19:30:00"),nacionalMadeira,porto,gw8));
			...
			gameList.add(new Game(format.parse("2015-10-25 19:15:00"),porto,sporting,gw8));
			...
			gameList.add(new Game(format.parse("2015-10-31 16:15:00"),sporting,belenenses,gw9));
			...
			gameList.add(new Game(format.parse("2015-11-01 19:15:00"),porto,maritimo,gw9));
			...
			gameList.add(new Game(format.parse("2015-11-08 16:00:00"),benfica,porto,gw10));
			...
			gameList.add(new Game(format.parse("2015-11-09 21:00:00"),uniaoMadeira,sporting,gw10));
			gameList.add(new Game(format.parse("2015-11-27 20:30:00"),nacionalMadeira,maritimo,gw11));
			gameList.add(new Game(format.parse("2015-11-28 20:45:00"),porto,guimaraes,gw11));
			...
			gameList.add(new Game(format.parse("2015-11-30 21:00:00"),sporting,benfica,gw11));
			...
			gameList.add(new Game(format.parse("2015-12-06 16:00:00"),arouca,porto,gw12));
			gameList.add(new Game(format.parse("2015-12-06 17:00:00"),moreirense,sporting,gw12));
			gameList.add(new Game(format.parse("2015-12-07 20:00:00"),guimaraes,rioAve,gw12));
			gameList.add(new Game(format.parse("2015-12-11 20:30:00"),porto,estoril,gw13));
			...
			gameList.add(new Game(format.parse("2015-12-13 20:30:00"),tondela,sporting,gw13));
			...
			gameList.add(new Game(format.parse("2015-12-21 19:00:00"),belenenses,porto,gw14));
			gameList.add(new Game(format.parse("2015-12-21 21:00:00"),sporting,pacos,gw14));
			...
			gameList.add(new Game(format.parse("2016-01-02 16:00:00"),porto,moreirense,gw15));
			gameList.add(new Game(format.parse("2016-01-02 16:00:00"),academica,uniaoMadeira,gw15));
			gameList.add(new Game(format.parse("2016-01-02 16:15:00"),setubal,sporting,gw15));
			...
			gameList.add(new Game(format.parse("2016-01-06 16:00:00"),uniaoMadeira,porto,gw16));
			...
			gameList.add(new Game(format.parse("2016-01-06 16:00:00"),sporting,academica,gw16));
			...
			gameList.add(new Game(format.parse("2016-01-10 16:00:00"),sporting,sporting,gw17));
			...
			gameList.add(new Game(format.parse("2016-01-10 18:15:00"),porto,porto,gw17));
			...
			gameList.add(new Game(format.parse("2016-01-17 18:15:00"),nacionalMadeira,sporting,gw18));
			gameList.add(new Game(format.parse("2016-01-17 20:30:00"),guimaraes,porto,gw18));
			gameList.add(new Game(format.parse("2016-01-18 20:00:00"),porto,setubal,gw18));
			...
			gameList.add(new Game(format.parse("2016-01-24 18:15:00"),sporting,rioAve,gw19));
			gameList.add(new Game(format.parse("2016-01-24 20:30:00"),porto,maritimo,gw19));
			gameList.add(new Game(format.parse("2016-01-25 20:00:00"),tondela,porto,gw19));
			...
			gameList.add(new Game(format.parse("2016-01-31 18:00:00"),porto,sporting,gw20));
			...
			gameList.add(new Game(format.parse("2016-02-07 16:00:00"),pacos,porto,gw21));
			...
			gameList.add(new Game(format.parse("2016-02-08 21:00:00"),sporting,estoril,gw21));
			...
			gameList.add(new Game(format.parse("2016-02-14 17:00:00"),porto,academica,gw22));
			gameList.add(new Game(format.parse("2016-02-14 19:15:00"),maritimo,sporting,gw22));
			...
			gameList.add(new Game(format.parse("2016-02-21 20:30:00"),sporting,guimaraes,gw23));
			gameList.add(new Game(format.parse("2016-02-22 20:00:00"),sporting,porto,gw23));
			...
			gameList.add(new Game(format.parse("2016-02-27 16:15:00"),porto,rioAve,gw24));
			gameList.add(new Game(format.parse("2016-02-27 18:30:00"),arouca,sporting,gw24));
			...
			gameList.add(new Game(format.parse("2016-03-06 16:00:00"),porto,nacionalMadeira,gw25));
			...
			gameList.add(new Game(format.parse("2016-03-06 20:30:00"),sporting,porto,gw25));
			gameList.add(new Game(format.parse("2016-03-07 20:00:00"),rioAve,estoril,gw25));
			gameList.add(new Game(format.parse("2016-03-11 20:30:00"),maritimo,porto,gw26));
			...
			gameList.add(new Game(format.parse("2016-03-13 20:30:00"),belenenses,sporting,gw26));
			...
			gameList.add(new Game(format.parse("2016-03-20 18:15:00"),porto,benfica,gw27));
			gameList.add(new Game(format.parse("2016-03-20 20:30:00"),sporting,uniaoMadeira,gw27));
			gameList.add(new Game(format.parse("2016-04-01 19:30:00"),benfica,sporting,gw28));
			...
			gameList.add(new Game(format.parse("2016-04-02 19:45:00"),guimaraes,porto,gw28));
			...
			gameList.add(new Game(format.parse("2016-04-08 19:30:00"),porto,arouca,gw29));
			...
			gameList.add(new Game(format.parse("2016-04-10 19:30:00"),sporting,moreirense,gw29));
			...
			gameList.add(new Game(format.parse("2016-04-16 17:30:00"),estoril,porto,gw30));
			...
			gameList.add(new Game(format.parse("2016-04-18 18:00:00"),sporting,tondela,gw30));
			gameList.add(new Game(format.parse("2016-04-18 20:00:00"),benfica,setubal,gw30));
			gameList.add(new Game(format.parse("2016-04-22 19:30:00"),porto,belenenses,gw31));
			...
			gameList.add(new Game(format.parse("2016-04-23 19:45:00"),pacos,sporting,gw31));
			...
			gameList.add(new Game(format.parse("2016-04-29 20:00:00"),sporting,setubal,gw32));
			...
			gameList.add(new Game(format.parse("2016-05-01 15:00:00"),moreirense,porto,gw32));
			...
			gameList.add(new Game(format.parse("2016-05-08 15:00:00"),academica,sporting,gw33));
			...
			gameList.add(new Game(format.parse("2016-05-08 15:00:00"),porto,uniaoMadeira,gw33));
			...
			gameList.add(new Game(format.parse("2016-05-14 10:45:00"),porto,porto,gw34));
			...
			gameList.add(new Game(format.parse("2016-05-15 16:00:00"),sporting,sporting,gw34));
